...
<?=Form::open('materialsstudentszaochadd/add', array('enctype' => 'multipart/form-data'))?>
<table cellpadding="0" cellspacing="0">
    ...
    <tr class="a">
        ...
        <td><?=Form::input('author', $user1, array('readonly'=>'readonly'))?></td>
    </tr>
    <tr class="b">
        <td ><?=Form::label('date', 'Дата')?>:</td>
        <td ><?=Form::input('date', $date['date'] = date ("Y-m-d"), array('class'=>'numeric', 'readonly'=>'readonly'))?></td>
    </tr>
    <tr class="a">
