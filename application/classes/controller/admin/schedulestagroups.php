...
/*
 * Розклад занять студентам - стаціонарні групи
 */
class Controller_Admin_Schedulestagroups extends Controller_Admin {
    ...
    public function before() {
        ...
        $this->template->page_title = 'Стаціонарні групи';
        $this->template->title = 'Стаціонарні групи';
    }
    ...
    public function action_index() {
        ...
        $content = View::factory('admin/schedule_sta_groups/schedule_sta_groups_index_view', array (
    ...
    public function action_add() {
        ...
        if (isset($_POST['submit'])) {
            ...
            $schedule_groups = ORM::factory('schedulegroups');
            ...
            try {
                ...
                $this->request->redirect('admin/schedulestagroups');
            }
        ...
        $content = View::factory('admin/schedule_sta_groups/schedule_sta_groups_add_view')
            ->bind('errors', $errors)
            ->bind('data', $data);
    ...
    public function action_edit() {
        ...
        $schedule_groups = ORM::factory('schedulegroups', $id);
        ...
        $content = View::factory('admin/schedule_sta_groups/schedule_sta_groups_edit_view')
            ->bind('id', $id)
            ->bind('errors', $errors)
            ->bind('data', $data);
