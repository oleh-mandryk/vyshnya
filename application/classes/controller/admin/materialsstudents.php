 ...
 */
class Controller_Admin_Materialsstudents extends Controller_Admin {
    ...
    public function before() {
        ...
        $this->template->title = 'Методичні матеріали студенту стаціонару';
    }
    
    public function action_index() {
        
        $count = ORM::factory('materialsstudents')->count_all();
        ...
        $content = View::factory('admin/materials_students/materials_students_index_view', array (
    ...
    public function action_add() {
        ...
        if (isset($_POST['submit'])) {
            ...
            if (($jjj!= 0)and($kkk == 1)) { 
                ...
                $this->request->redirect('admin/materialsstudents');
            }
        }

        $content = View::factory('admin/materials_students/materials_students_add_view')
            ->bind('errors', $errors)
    ...
    public function action_edit() {
        ...
        $content = View::factory('admin/materials_students/materials_students_edit_view')
            ->bind('id', $id)
            ->bind('errors', $errors)
            ->bind('errors_cap', $errors_cap)
            ->bind('data', $data)
