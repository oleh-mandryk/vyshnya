 ...
 */
class Controller_Admin_Materialsstudentszaoch extends Controller_Admin {
    ...
    public function before() {
        ...
        $this->template->title = 'Методичні матеріали студенту заочникам';
    }
    
    public function action_index() {
        
        $count = ORM::factory('materialsstudentszaoch')->count_all();
        ...
        $content = View::factory('admin/materials_students_zaoch/materials_students_index_view', array (
    ...
    public function action_add() {
        ...
        if (isset($_POST['submit'])) {
            ...
            $validate = Validation::factory($_FILES);
                ...
                $validate->rule('url_material', 'Upload::size', array(':value', '10M'));
            ...
            if (($jjj!= 0)and($kkk == 1)) { 
                ...
                $this->request->redirect('admin/materialsstudentszaoch');
            }
        }

        $content = View::factory('admin/materials_students_zaoch/materials_students_add_view')
            ->bind('errors', $errors)
    ...
    public function action_edit() {
        ...
        $content = View::factory('admin/materials_students_zaoch/materials_students_edit_view')
            ->bind('id', $id)
            ->bind('errors', $errors)
            ->bind('errors_cap', $errors_cap)
            ->bind('data', $data)
