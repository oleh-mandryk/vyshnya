...
/*
 * Методичні матеріали студентам заочникам
 */
class Controller_Index_Materialsstudentszaochadd extends Controller_Index {
    ...
    public function before() {
        ...
        // Вивід в шаблон
        $this->template->page_title = 'Методичні матеріали студентам заочникам';
        $this->template->title = 'Методичні матеріали студентам заочникам';
    }
    ...
    public function action_index() {
        ...
        $count = ORM::factory('materialsstudentszaoch')->where('author','=',$user1)->count_all();
        ...
        $materials_students = ORM::factory('materialsstudentszaoch')
            ->order_by('id','desc')
            ->where('author','=',$user1)
        ...
        $content = View::factory('index/materials_students_zaoch_add/materials_students_add_index_view', array (
    ...
    public function action_add() {
        ...
        if (isset($_POST['submit'])) {
            ...
            if (($jjj!= 0)and($kkk == 1)) { 
                $directory = 'media/files/materials_students_zaoch';
                // Запис в БД
                ...
                $this->request->redirect('materialsstudentszaochadd');
            }
        }

        $content = View::factory('index/materials_students_zaoch_add/materials_students_add_add_view')
            ->bind('errors', $errors)
    ...
    public function action_edit() {
        ...
        $materials_students = ORM::factory('materialsstudentszaoch', $id);
        ...
        if (isset($_POST['submit'])) {
            ...
            if (($jjj!= 0)and($kkk == 1)) {
                ...
                if (!empty($_FILES['url_material']['name'])) {
                    ...
                    unlink('./media/files/materials_students_zaoch/'.$file_del);
        ...
        $content = View::factory('index/materials_students_zaoch_add/materials_students_add_edit_view')
            ->bind('id', $id)
            ->bind('errors', $errors)
            ->bind('errors_cap', $errors_cap)
            ->bind('data', $data)
