 ...
 */
class Controller_Index_Materialsstudentszaoch extends Controller_Index {
    ...
    public function action_index() {
        ...
        $menu_materials_students = new Model_Menumaterialsstudentszaoch();
        $menu_materials_students_ft = $menu_materials_students->showMenuMaterialsStudents();
        
        $content = View::factory('index/materials_students_zaoch/materials_students_menu_view', array(
    ...
    public function action_show() {
        ...
        $title_mat = ORM::factory('menumaterialsstudentszaoch', $id); 
                
        $materials_students = new Model_Materialsstudentszaoch();
        ...
        $content = View::factory('index/materials_students_zaoch/materials_students_show_view', array(
